...
import LikertScaleTable from './table'
...
export default function LikertScale({
  ...
  return (
    <div className="m-likert-scale">
      <div style={{ flex: 1, display: 'flex' }}>
        <ContentField
          className="form-input-stretch"
          label={isAudio ? 'Nội dung bài nghe' : 'Nội dung bài đọc'}
          strValue={isAudio ? question?.audio_script : question?.question_text}
          disableTab={true}
          //styleAction={['b', 'i', 'u']}
